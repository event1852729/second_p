<?php
			...
			$sql = "insert into fix(fix_location,fix_item,fix_detail,fix_image,cm_ID,mem_ID,mem_name,email) values 		('$fix_location','$fix_item','$fix_detail','$a$b','$cm_ID','$mem_ID','$mem_name','$email')";
